...
var require_github_slugger = __commonJS({
  "node_modules/github-slugger/index.js"(exports, module2) {
    ...
    var own9 = Object.hasOwnProperty;
    function BananaSlug() {
      const self2 = this;
    ...
    BananaSlug.prototype.slug = function(value2, maintainCase) {
      ...
      while (own9.call(self2.occurrences, slug)) {
    ...
    function slugger(string, maintainCase) {
      ...
      return string.replace(regex2, "").replace(/ /g, "-");
    }
...
var require_is_plain_obj = __commonJS({
  "node_modules/estree-util-value-to-estree/node_modules/is-plain-obj/index.js"(exports, module2) {
    "use strict";
...
var require_dist = __commonJS({
  "node_modules/estree-util-value-to-estree/dist/index.js"(exports) {
    ...
    function valueToEstree2(value2, options2 = {}) {
      if (value2 === void 0) {
      ...
      if (typeof value2 === "boolean") {
        return { type: "Literal", value: value2, raw: String(value2) };
      }
      if (typeof value2 === "bigint") {
        return value2 >= 0 ? { type: "Literal", value: value2, raw: `${value2}n`, bigint: String(value2) } : {
          type: "UnaryExpression",
          operator: "-",
          prefix: true,
          argument: valueToEstree2(-value2, options2)
        };
      }
      if (typeof value2 === "number") {
        return value2 >= 0 ? { type: "Literal", value: value2, raw: String(value2) } : {
          type: "UnaryExpression",
          operator: "-",
          prefix: true,
          argument: valueToEstree2(-value2, options2)
      ...
      if (typeof value2 === "string") {
        return { type: "Literal", value: value2, raw: JSON.stringify(value2) };
      }
      if (typeof value2 === "symbol") {
        if (value2.description && value2 === Symbol.for(value2.description)) {
          return {
            ...
            arguments: [valueToEstree2(value2.description, options2)]
          };
        }
      ...
      if (Array.isArray(value2)) {
        ...
        for (let i2 = 0; i2 < value2.length; i2 += 1) {
          elements.push(i2 in value2 ? valueToEstree2(value2[i2], options2) : null);
        }
      ...
      if (value2 instanceof Date) {
        return {
          ...
          arguments: [valueToEstree2(value2.getTime(), options2)]
        };
      }
      if (value2 instanceof Map) {
        return {
          ...
          arguments: [valueToEstree2([...value2.entries()], options2)]
        };
      }
      if (typeof Buffer !== "undefined" && Buffer.isBuffer(value2)) {
        return {
          ...
          arguments: [valueToEstree2([...value2.values()])]
        };
      }
      if (value2 instanceof BigInt64Array || value2 instanceof BigUint64Array || value2 instanceof Float32Array || value2 instanceof Float64Array || value2 instanceof Int8Array || value2 instanceof Int16Array || value2 instanceof Int32Array || value2 instanceof Set || value2 instanceof Uint8Array || value2 instanceof Uint8ClampedArray || value2 instanceof Uint16Array || value2 instanceof Uint32Array) {
        return {
          type: "NewExpression",
          callee: { type: "Identifier", name: value2.constructor.name },
          arguments: [valueToEstree2([...value2], options2)]
        };
      }
      if (value2 instanceof URL || value2 instanceof URLSearchParams) {
        return {
          type: "NewExpression",
          callee: { type: "Identifier", name: value2.constructor.name },
          arguments: [valueToEstree2(String(value2), options2)]
        };
      }
      if (options2.instanceAsObject || isPlainObject(value2)) {
        return {
          type: "ObjectExpression",
          properties: Object.entries(value2).map(([name, val]) => ({
            type: "Property",
            method: false,
            shorthand: false,
            computed: false,
            kind: "init",
            key: valueToEstree2(name, options2),
            value: valueToEstree2(val, options2)
          }))
        };
      }
...
var require_visit = __commonJS({
  "node_modules/yaml/dist/visit.js"(exports) {
    ...
    function callVisitor(key, node, visitor, path2) {
      ...
      if (Node.isMap(node))
        return (_a5 = visitor.Map) == null ? void 0 : _a5.call(visitor, key, node, path2);
      if (Node.isSeq(node))
...
var require_createNode = __commonJS({
  "node_modules/yaml/dist/doc/createNode.js"(exports) {
    ...
    function findTagObject(value2, tagName, tags) {
      ...
      return tags.find((t2) => {
        var _a5;
        return ((_a5 = t2.identify) == null ? void 0 : _a5.call(t2, value2)) && !t2.format;
      });
    }
    function createNode(value2, tagName, ctx) {
      ...
      if (Node.isPair(value2)) {
        const map = (_b = (_a5 = ctx.schema[Node.MAP]).createNode) == null ? void 0 : _b.call(_a5, ctx.schema, null, ctx);
...
${indent2}`);
      if (actualString) {
        const test = (tag) => {
          var _a5;
          return tag.default && tag.tag !== "tag:yaml.org,2002:str" && ((_a5 = tag.test) == null ? void 0 : _a5.test(str));
        };
  ...
  "node_modules/yaml/dist/stringify/stringify.js"(exports) {
    ...
    function getTagObject(tags, item) {
      ...
      if (Node.isScalar(item)) {
        ...
        const match = tags.filter((t2) => {
          var _a6;
          return (_a6 = t2.identify) == null ? void 0 : _a6.call(t2, obj);
        });
      ...
      if (!tagObj) {
        const name = ((_a5 = obj == null ? void 0 : obj.constructor) == null ? void 0 : _a5.name) ?? typeof obj;
    ...
    function stringify2(item, ctx, onComment, onChompKeep) {
      ...
      if (Node.isAlias(item)) {
        ...
        if ((_a5 = ctx.resolvedAliases) == null ? void 0 : _a5.has(item)) {
  ...
  "node_modules/yaml/dist/nodes/YAMLMap.js"(exports) {
    ...
    var YAMLMap = class extends Collection.Collection {
      ...
      add(pair, overwrite) {
        ...
        const sortEntries = (_a5 = this.schema) == null ? void 0 : _a5.sortMapEntries;
        if (prev) {
          if (!overwrite)
...
var require_stringifyDocument = __commonJS({
  "node_modules/yaml/dist/stringify/stringifyDocument.js"(exports) {
    ...
    function stringifyDocument(doc, options2) {
      ...
      if ((_a5 = doc.directives) == null ? void 0 : _a5.docEnd) {
        if (doc.comment) {
  ...
  "node_modules/yaml/dist/compose/resolve-block-map.js"(exports) {
    ...
    function resolveBlockMap({ composeNode, composeEmptyNode }, ctx, bm, onError) {
      ...
      for (const collItem of bm.items) {
        ...
        } else if (((_a5 = keyProps.found) == null ? void 0 : _a5.indent) !== bm.indent) {
          onError(offset, "BAD_INDENT", startColMsg);
        }
  ...
  "node_modules/yaml/dist/compose/resolve-block-seq.js"(exports) {
    ...
    function resolveBlockSeq({ composeNode, composeEmptyNode }, ctx, bs, onError) {
      ...
      for (const { start, value: value2 } of bs.items) {
        ...
        const node = value2 ? composeNode(ctx, value2, props, onError) : composeEmptyNode(ctx, offset, start, null, props, onError);
        if (ctx.schema.compat)
  ...
  "node_modules/yaml/dist/compose/compose-scalar.js"(exports) {
    ...
    function findScalarTagByName(schema, value2, tagName, tagToken, onError) {
      ...
      for (const tag of matchWithTest)
        if ((_a5 = tag.test) == null ? void 0 : _a5.test(value2))
          return tag;
    ...
    function findScalarTagByTest({ directives, schema }, value2, token, onError) {
      const tag = schema.tags.find((tag2) => {
        var _a5;
        return tag2.default && ((_a5 = tag2.test) == null ? void 0 : _a5.test(value2));
      }) || schema[Node.SCALAR];
      if (schema.compat) {
      ...
      for (let i2 = 0; i2 < prelude.length; ++i2) {
        ...
        switch (source[0]) {
          case "#":
            ...
            break;
          case "%":
            if (((_a5 = prelude[i2 + 1]) == null ? void 0 : _a5[0]) !== "#")
              i2 += 1;
            atComment = false;
            break;
          default:
...
var require_parser = __commonJS({
  "node_modules/yaml/dist/parse/parser.js"(exports) {
    ...
    function getFirstKeyStartProps(prev) {
      ...
      while (((_a5 = prev[++i2]) == null ? void 0 : _a5.type) === "space") {
      }
          ...
          case "comment":
            if (it.value) {
              ...
              if (this.atIndentedComment(it.start, map.indent)) {
                ...
                const end = (_a5 = prev == null ? void 0 : prev.value) == null ? void 0 : _a5.end;
...
function decodeNamedCharacterReference(value2) {
  return own4.call(characterEntities, value2) ? characterEntities[value2] : false;
}
var own4;
...
function hasProperty2(node, name) {
  var value2 = name && node && typeof node === "object" && node.type === "element" && node.properties && own8.call(node.properties, name) && node.properties[name];
...
var import_streams, POOL_SIZE, _parts, _type, _size, _endings, _a2, _Blob, Blob, fetch_blob_default;
    ...
    _Blob = (_a2 = class {
      constructor(blobParts = [], options2 = {}) {
        ...
        for (const element2 of blobParts) {
          ...
          } else if (element2 instanceof _a2) {
            part = element2;
          } else {
...
var _lastModified, _name, _a3, _File, File, file_default;
var init_file = __esm({
  "node_modules/fetch-blob/file.js"() {
    init_fetch_blob();
...
var t, i, h2, r2, m, f, e, x, _d, _a4, FormData;
...
var import_estree_util_value_to_estree = __toESM(require_dist(), 1);
init_hast_util_heading_rank();
...
function getPathnameFromDirPath(opts, dirPath) {
  const relFilePath = (0, import_path.relative)(opts.routesDir, dirPath);
  const pathname = normalizePath(relFilePath);
  return normalizePathname(pathname, opts.basePathname, opts.trailingSlash).split("/").filter((segment) => !segment.startsWith("__")).join("/");
}
function getMenuPathname(opts, filePath) {
  let pathname = normalizePath((0, import_path.relative)(opts.routesDir, filePath));
  pathname = `/` + normalizePath((0, import_path.dirname)(pathname));
...
function normalizePath(path2) {
  path2 = (0, import_path.normalize)(path2);
...
function createFileId(routesDir, path2) {
  const ids = [];
  for (let i2 = 0; i2 < 25; i2++) {
    let baseName = removeExtension((0, import_path.basename)(path2));
    ...
    path2 = normalizePath((0, import_path.dirname)(path2));
    if (path2 === routesDir) {
      break;
    }
  }
...
function frontmatterAttrsToDocumentHead(attrs) {
  if (attrs && Object.keys(attrs).length > 0) {
    const head = { title: "", meta: [], styles: [], links: [] };
...
function getMarkdownRelativeUrl(opts, containingFilePath, url, checkFileExists) {
  ...
  if (isMarkdownExt(getExtension(strippedUrl))) {
    ...
    const filePath = isAbsolute3 ? (0, import_path2.join)(opts.routesDir, ...parts) : (0, import_path2.join)((0, import_path2.dirname)(containingFilePath), ...parts);
    if (checkFileExists && !(0, import_fs4.existsSync)(filePath)) {
      console.warn(
        `
...
`
    ...
    if (sourceFileName) {
      const mdDirPath = (0, import_path2.dirname)(filePath);
              ...
              declarations: [
                {
                  ...
                  init: (0, import_estree_util_value_to_estree.valueToEstree)(val)
                }
              ]
            }
          }
...
function hasProperty(node, propName) {
  const value2 = propName && node && typeof node === "object" && node.type === "element" && node.properties && own.call(node.properties, propName) && node.properties[propName];
...
function core(schema, defaultTagName, caseSensitive) {
  ...
  const h3 = function(selector, properties, ...children) {
    ...
    if (selector === void 0 || selector === null) {
      ...
      if (adjust && own3.call(adjust, node.tagName)) {
        node.tagName = adjust[node.tagName];
      }
      if (isProperties(properties, node.tagName)) {
        let key;
        for (key in properties) {
          if (own3.call(properties, key)) {
...
function highlight(value2, language) {
  ...
  if (language && typeof language === "object") {
    ...
    if (own5.call(refractor.languages, name)) {
...
function listLanguages() {
  ...
  for (language in languages) {
    if (own5.call(languages, language) && typeof languages[language] === "object") {
      list.push(language);
    }
  }
  return list;
...
async function createMdxTransformer(ctx) {
  ...
  const mdxOpts = {
    ...
    ...userMdxOpts,
    remarkPlugins: [...userRemarkPlugins, remarkGfm2, remarkFrontmatter2, [parseFrontmatter, ctx]],
    rehypePlugins: [
      ...userRehypePlugins,
...
function createRoutes(ctx, c2, esmImports) {
...
/** Qwik City Routes (${ctx.routes.length}) */`);
  ...
  for (const route of ctx.routes) {
    ...
    if (loaders.length > 0) {
      c2.push(`  ${createRouteData(route, loaders, isSsr)},`);
    }
  }
  c2.push(`];`);
}
function createRouteData(r3, loaders, isSsr) {
  ...
  if (isSsr) {
    ...
    const clientBundleNames = JSON.stringify(getClientRouteBundleNames(r3));
...
function getClientRouteBundleNames(r3) {
  const bundlesNames = [];
  const manifest = globalThis.QWIK_MANIFEST;
  if (manifest) {
...
function generateQwikCityPlan(ctx) {
  const esmImports = [];
  const c2 = [];
  c2.push(`
/** Qwik City Plan */`);
  createRoutes(ctx, c2, esmImports);
...
function normalizeOptions(rootDir, userOpts) {
  ...
  if (typeof opts.routesDir !== "string") {
    opts.routesDir = (0, import_path3.resolve)(rootDir, "src", "routes");
  } else if (!(0, import_path3.isAbsolute)(opts.routesDir)) {
    opts.routesDir = (0, import_path3.resolve)(rootDir, opts.routesDir);
  }
...
async function validatePlugin(opts) {
  ...
  if (!(0, import_path4.isAbsolute)(opts.routesDir)) {
    throw new Error(
      `qwikCity plugin "routesDir" option must be an absolute path: ${opts.routesDir}`
    );
  }
  try {
    const s3 = await import_fs10.default.promises.stat(opts.routesDir);
    if (!s3.isDirectory()) {
...
async function walkRoutes(routesDir) {
  const sourceFiles = [];
  await walkRouteDir(sourceFiles, normalizePath(routesDir), (0, import_path5.basename)(routesDir));
  return sourceFiles;
}
async function walkRouteDir(sourceFiles, dirPath, dirName) {
  try {
    const dirItemNames = await import_fs11.default.promises.readdir(dirPath);
    await Promise.all(
      dirItemNames.map(async (itemName) => {
        const itemPath = normalizePath((0, import_path5.join)(dirPath, itemName));
...
function parseMenu(opts, filePath, content) {
  const parsedMenu = {
    text: ""
  };
          ...
          for (const liToken of li.tokens) {
            if (liToken.type === "text") {
              for (const liItem of liToken.tokens) {
                if (liItem.type === "text") {
                  h22.items.push({ text: liItem.text });
...
function parseRoutePathname(pathname) {
  ...
  const pattern = new RegExp(
    `^${segments.map((segment, i2, segments2) => {
...
function resolveRoute(opts, appLayouts, sourceFile) {
  ...
  if (!layoutStop) {
    let currentDir = normalizePath((0, import_path6.dirname)(filePath));
    ...
    for (let i2 = 0; i2 < 20; i2++) {
      ...
      currentDir = normalizePath((0, import_path6.dirname)(currentDir));
    }
  }
  const buildRoute = {
    id: createFileId(opts.routesDir, filePath),
...
async function loadUserResponse(requestCtx, params, routeModules, platform, trailingSlash, basePathname = "/") {
...
function staticDistMiddleware({ config }) {
  const distDirs = new Set(
    ["dist", config.build.outDir, config.publicDir].map(
      (d) => normalizePath((0, import_path7.resolve)(config.root, d))
    )
  );
  return async (req, res, next) => {
    const url = new URL(req.originalUrl, `http://${req.headers.host}`);
    ...
    for (const distDir of distDirs) {
      try {
        const filePath = (0, import_path7.join)(distDir, relPath);
        const s3 = await import_fs15.default.promises.stat(filePath);
        if (s3.isFile()) {
          res.writeHead(200, {
            "Content-Type": contentType,
            "X-Source-Path": filePath
          });
          import_fs15.default.createReadStream(filePath).pipe(res);
          return;
        }
      } catch (e2) {
      }
...
function stripServerEndpoints(code2, id) {
  ...
  for (const s3 of sourceFile.statements) {
    ...
    if (!((_a5 = s3.modifiers) == null ? void 0 : _a5.some((m2) => m2.kind === import_typescript3.default.SyntaxKind.ExportKeyword))) {
      continue;
    }
...
var qwik_city_sw_register_build_default = '((s,a,r,i)=>{r=(e,t)=>{t=document.querySelector("[q\\\\:base]"),t&&a.active&&a.active.postMessage({type:"qprefetch",base:t.getAttribute("q:base"),...e})},addEventListener("qprefetch",e=>{const t=e.detail;a?r(t):t.bundles&&s.push(...t.bundles)}),navigator.serviceWorker.register("__url").then(e=>{i=()=>{a=e,r({bundles:s})},e.installing?e.installing.addEventListener("statechange",t=>{t.target.state=="activated"&&i()}):e.active&&i()}).catch(e=>console.error(e))})([])';
...
function qwikCity(userOpts) {
  ...
  const plugin = {
    ...
    async configResolved(config) {
      var _a5;
      rootDir = (0, import_path8.resolve)(config.root);
      const target = ((_a5 = config.build) == null ? void 0 : _a5.ssr) || config.mode === "ssr" ? "ssr" : "client";
    ...
    resolveId(id) {
      if (id === QWIK_CITY_PLAN_ID || id === QWIK_CITY_ENTRIES_ID || id === QWIK_CITY_SW_REGISTER) {
        return (0, import_path8.join)(rootDir, id);
      }
      return null;
    },
    async load(id) {
    ...
    async transform(code2, id) {
      if (ctx) {
        const fileName = (0, import_path8.basename)(id);
    ...
    async writeBundle() {
      if ((ctx == null ? void 0 : ctx.target) === "ssr") {
        const manifest = globalThis.QWIK_MANIFEST;
        const clientOutDir = globalThis.QWIK_CLIENT_OUT_DIR;
        if (manifest && clientOutDir) {
          for (const swEntry of ctx.serviceWorkers) {
            try {
              const swClientDistPath = (0, import_path8.join)(clientOutDir, swEntry.chunkFileName);
              const swCode = await (0, import_promises.readFile)(swClientDistPath, "utf-8");
              const swCodeUpdate = prependManifestToServiceWorker(ctx, manifest, swCode);
              if (swCodeUpdate) {
                await (0, import_promises.writeFile)(swClientDistPath, swCodeUpdate);
              }
            } catch (e2) {
              console.error(e2);
            }
