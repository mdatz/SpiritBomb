...
function createFileId(routesDir, path2) {
  ...
  for (let i2 = 0; i2 < 25; i2++) {
    let baseName = removeExtension(basename(path2));
    ...
    path2 = normalizePath(dirname(path2));
    if (path2 === routesDir) {
      break;
    }
  }
...
function stripServerEndpoints(code2, id) {
  ...
  for (const s3 of sourceFile.statements) {
    ...
    if (!((_a5 = s3.modifiers) == null ? void 0 : _a5.some((m2) => m2.kind === ts.SyntaxKind.ExportKeyword))) {
      continue;
    }
