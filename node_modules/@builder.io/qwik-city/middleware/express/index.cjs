...
// packages/qwik-city/middleware/express/index.ts
var express_exports = {};
...
async function requestHandler(requestCtx, render, platform, opts) {
  try {
    updateRequestCtx(requestCtx, import_qwik_city_plan.trailingSlash);
    const loadedRoute = await loadRoute(import_qwik_city_plan.routes, import_qwik_city_plan.menus, import_qwik_city_plan.cacheModules, requestCtx.url.pathname);
    if (loadedRoute) {
      ...
      const userResponse = await loadUserResponse(
        ...
        mods,
        platform,
        import_qwik_city_plan.trailingSlash,
        import_qwik_city_plan.basePathname
      );
...
// packages/qwik-city/middleware/express/node-fetch.ts
...
function fromExpressHttp(req, res) {
